...
:root{
  ...
  --glass-black: rgba(8,8,8,0.32);
  --glass-white: rgba(255,255,255,0.16);
  --glass-dark: rgba(20,18,16,0.26);
  --radius: 26px;
  --blur: 20px;
...
.stat-glass-orange{ background: linear-gradient(160deg, rgba(255,122,61,0.50), rgba(255,90,31,0.40) 55%, rgba(122,31,92,0.30)); border-color: rgba(255,154,82,0.35); }
.stat-glass-white{ background: linear-gradient(160deg, rgba(61,127,255,0.50) 0%, rgba(20,34,79,0.50) 100%); border-color: rgba(120,160,255,0.32); }
.stat-glass-black{ background: linear-gradient(160deg, rgba(157,111,255,0.50) 0%, rgba(42,26,74,0.50) 100%); border-color: rgba(180,140,255,0.30); }
.stat-plain{ background: linear-gradient(160deg, rgba(40,36,32,0.38), rgba(10,9,8,0.42)); }
...
/* ---------- CARD PANEL ---------- */
.panel{
  background: linear-gradient(175deg, rgba(30,26,38,0.30), var(--glass-dark) 60%);
...
.answer-card{
  ...
  background: linear-gradient(155deg, rgba(255,90,31,0.16) 0%, rgba(157,111,255,0.11) 55%, rgba(10,10,10,0.34) 100%);
...
/* ---------- HISTORY CARDS ---------- */
.hist-card{
  border: 1px solid var(--card-border); background: linear-gradient(165deg, rgba(28,24,34,0.32), var(--glass-dark) 65%);
  border-radius: 18px;
