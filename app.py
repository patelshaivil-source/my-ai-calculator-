...
.welcome-sub{
  color: var(--text-dim); font-size: 1.02rem; max-width: 460px; line-height:1.55; margin: 0 0 6px 0;
}
.welcome-wrap .stButton{ display:flex; justify-content:center; }
...
if st.session_state.app_stage == "loading":
    ...
    <div class="welcome-wrap">
      ...
      <div class="welcome-sub">Your AI-powered financial voice assistant is ready. Ask by voice or text and get instant, clear answers to your money questions.</div>
    """, unsafe_allow_html=True)
