...
.stat-glass-orange{ background: linear-gradient(160deg, rgba(59,130,246,0.88) 0%, rgba(10,22,55,0.80) 100%); border-color: rgba(120,170,255,0.35); }
.stat-glass-white{ background: linear-gradient(160deg, rgba(34,197,94,0.88) 0%, rgba(6,38,22,0.80) 100%); border-color: rgba(110,220,150,0.32); }
.stat-glass-black{ background: linear-gradient(160deg, rgba(234,179,8,0.88) 0%, rgba(48,38,4,0.80) 100%); border-color: rgba(250,210,90,0.32); }
.stat-plain{ background: linear-gradient(160deg, rgba(239,68,68,0.88) 0%, rgba(50,10,12,0.80) 100%); }
